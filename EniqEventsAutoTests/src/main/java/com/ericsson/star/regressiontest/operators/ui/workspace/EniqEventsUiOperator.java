package com.ericsson.star.regressiontest.operators.ui.workspace;
...
import com.ericsson.star.regressiontest.test.pages.ui.workspace.WorkSpaceTimeRangeViewModel;

public class EniqEventsUiOperator implements UiOperator{
	...
	private WorkSpaceTimeRangeViewModel timeRangeView;
	
	private static String URL;
	private static String USER;
	private static String PASSWD;

	public EniqEventsUiOperator(Map<String, Object> args){
	...
	public void displayTimeRange(){
		mainPage.clickTimeRange();
		pause(2000);
		timeRangeView = browserTab.getView(WorkSpaceTimeRangeViewModel.class);
	}
	
	public void selectTimeRange(){
		timeRangeView.selectOneDay();
		pause(2000);
	}
