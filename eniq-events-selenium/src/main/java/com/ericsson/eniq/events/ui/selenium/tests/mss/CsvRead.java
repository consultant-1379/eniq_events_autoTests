...
public class CsvRead {
	...
	/**
	 * Creates a {@link com.CsvRead.CsvRead CsvRead} object using a file
	 * as the data source.
	 * 
	 * @param fileName
	 ...
	 *            parsing the data.
	 */
	public CsvRead(String fileName, char delimiter, Charset charset)
	 ...
	 *            The character to use as the column delimiter.
	 */
	public CsvRead(String fileName, char delimiter)
			throws FileNotFoundException {
	...
	/**
	 * Constructs a {@link com.CsvRead.CsvRead CsvRead} object using a
	 ...
	 *            The character to use as the column delimiter.
	 */
	public CsvRead(Reader inputStream, char delimiter) {
		if (inputStream == null) {
			throw new IllegalArgumentException(
	 ...
	 *            The stream to use as the data source.
	 */
	public CsvRead(Reader inputStream) {
		this(inputStream, Letters.COMMA);
	}

	/**
	 * Constructs a {@link com.CsvRead.CsvRead CsvRead} object using an
	 ...
	 *            parsing the data.
	 */
	public CsvRead(InputStream inputStream, char delimiter, Charset charset) {
	 ...
	 *            parsing the data.
	 */
	public CsvRead(InputStream inputStream, Charset charset) {
	 ...
	 * {@link com.CsvRead.CsvRead#readHeaders readHeaders()}.
	 * 
	...
	/**
	 * Creates a {@link com.CsvRead.CsvRead CsvRead} object using a string
	 * of data as the source.&nbsp;Uses ISO-8859-1 as the
	 * {@link java.nio.charset.Charset Charset}.
	 * 
	 * @param data
	 *            The String of data to use as the source.
	 * @return A {@link com.CsvRead.CsvRead CsvRead} object using the
	 *         String of data as the source.
	 */
	public static CsvRead parse(String data) {
		if (data == null) {
			throw new IllegalArgumentException(
					"Parameter data can not be null.");
		}

		return new CsvRead(new StringReader(data));
	}
	 ...
	 * increment
	 * {@link com.CsvRead.CsvRead#getCurrentRecord getCurrentRecord()}.
	 * 
	...
	private void checkClosed() throws IOException {
		if (closed) {
			throw new IOException(
					"This instance of the CsvRead class has already been closed.");
		}
	}
	...
	private class UserSettings {
		...
		public UserSettings() {
			...
			UseComments = false;
			EscapeMode = CsvRead.ESCAPE_MODE_DOUBLED;
			SafetySwitch = true;
