...
public class SubscriberSessionTestGroupWithNewUILaunch extends EniqEventsUIBaseSeleniumTest {
    ...
    final List<String> defaultHeadersOnRoamingCallForwardFailedEventAnalysisWindow = new ArrayList<String>(Arrays.asList(
            ...
            GuiStringConstants.OUTGOING_ROUTE,GuiStringConstants.TAC,GuiStringConstants.IMSI,GuiStringConstants.TERMINAL_MAKE,
    ...
    final List<String> defaultHeadersOnCallForwardFailedEventAnalysisWindow = new ArrayList<String>(Arrays.asList(
            GuiStringConstants.EVENT_TIME, GuiStringConstants.MSC,GuiStringConstants.INCOMING_ROUTE,
            GuiStringConstants.OUTGOING_ROUTE,GuiStringConstants.IMSI,GuiStringConstants.EVENT_RESULT,
            GuiStringConstants.INTERNAL_CAUSE_CODE, GuiStringConstants.FAULT_CODE
            ));
    ...
    final List<String> optionalHeadersToBeChecked = new ArrayList<String>(Arrays.asList(GuiStringConstants.MSISDN,
            ...
            GuiStringConstants.INTERNAL_CAUSE_CODE_STR, GuiStringConstants.FAULT_CODE_ID,GuiStringConstants.RECOMMENDED_ACTION,
   ...
   //TODO after UI fix INTERNAL_CAUSE_CODE_STR has to be changed to INTERNAL_CAUSE_CODE_ID
    final List<String> allHeaders = new ArrayList<String>(Arrays.asList(GuiStringConstants.EVENT_TIME,
            ...
            GuiStringConstants.INTERNAL_CAUSE_CODE_STR,GuiStringConstants.INTERNAL_CAUSE_CODE,GuiStringConstants.FAULT_CODE_ID,
	...
	private String DEFAULT_TIME_RANGE = "30 minutes";
 //   @After
    @Override
    ...
    public void MSOriginatingEventCanBeDisplayedInSubscriberSession_5_1() throws Exception {
        ...
        openEventAnalysisWindowForMSS(SeleniumConstants.IMSI, false, imsi);        
    ...
    public void MSOriginatingEventInformationIntegrity_5_2() throws Exception {
        ...
        delayAndSetTimeRange(getTimeRangeFromProperties());
        //subscriberEventAnalysis.setTimeRange(getTimeRangeFromProperties());
    ...
    public void VerifyIMSIAndIMSIGroupSupportForSubscriberAnalysis_5_5_2() throws Exception {
        ...
        openEventAnalysisWindowForMSS(SeleniumConstants.IMSI_GROUP, true, imsiGroup);
    ...
    // sync pass
    @Test
    public void VerifyMSCDrillDownFunction_5_6() throws Exception {
        //              String imsi = "460000123456790";
        final String imsi = reservedDataHelper.getImsiSpecificData(ImsiNumber.IMSI_2G_MSS, ImsiSpecificDataType.IMSI);
        final TimeRange timeRange = getTimeRangeFromProperties();
    ...
    // sync pass
    @Test
    public void VerifyAccessAreaDrillDownFunction_5_7() throws Exception {
        //              String imsi = "460000123456790";
        final String imsi = reservedDataHelper.getImsiSpecificData(ImsiNumber.IMSI_2G_MSS, ImsiSpecificDataType.IMSI);
    ...
    // sync pass
    @Test
    public void VerifyTACDrillDownFunction_5_8() throws Exception {
        //              String imsi = "460000123456790";
        final String imsi = reservedDataHelper.getImsiSpecificData(ImsiNumber.IMSI_2G_MSS, ImsiSpecificDataType.IMSI);
    ...
    // sync pass
    @Test
    public void VerifyControllerDrillDownFunction_5_9() throws Exception {
        //              String imsi = "460000123456790";
        final String imsi = reservedDataHelper.getImsiSpecificData(ImsiNumber.IMSI_2G_MSS, ImsiSpecificDataType.IMSI);
    ...
    public void VerifyDateAndTimeRangeSupportForSubscriberAnalysis_5_11() throws Exception {
        ...
        assertTrue("The header is not right on IMSI",
                subscriberEventAnalysis.getTableHeaders().containsAll(defaultHeadersOnIMSIEventAnalysisWindow));
        setTimeAndDateAndVerify(subscriberEventAnalysis, "2012,11,20", TimeCandidates.AM_00_00, "2012,11,21",
    ...
    public void callForwardingEventCanBeDisplayedInSubscriberSession_5_14() throws Exception {
        ...
        assertTrue("Default time range is NOT equal to 30 minutes",
                subscriberEventAnalysis.getTimeRange().equals(DEFAULT_TIME_RANGE));
        //subscriberEventAnalysis.setTimeRange(getTimeRangeFromProperties());
        delayAndSetTimeRange(getTimeRangeFromProperties());
    ...
    public void SearchByMSISDN_5_16() throws Exception {
        ...
        openEventAnalysisWindowForMSS(SeleniumConstants.MSISDN, false, msisdn);
    ...
    private void openEventAnalysisWindowForMSS(String dimensionType,
    		boolean isGroup,
    		String dimensionValue) throws InterruptedException{
    	...
    	pause(2000);
        String categoryPanel = MssConstants.CATEGORY_CORE_EVENT_TRACE;
