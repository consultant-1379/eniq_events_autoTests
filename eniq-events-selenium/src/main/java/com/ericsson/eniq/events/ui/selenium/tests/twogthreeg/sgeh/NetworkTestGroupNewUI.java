...
//import com.ericsson.eniq.events.ui.selenium.tests.wcdmaHFA.BaseWcdmaHfa;

public class NetworkTestGroupNewUI extends EniqEventsUIBaseSeleniumTest {
    ...
    */
    ...
    public void displayFailureForSelectedSGSNAndDrillCauseCodeToSubCauseCodeLevel_4_8_10() throws Exception {
        ...
        //System.out.println("Through Cause Code " + searchValue);
       ...
       //causeCodeAnalysisWindow.clickCauseCodes("x-grid-group-div");
        selenium.click(base2G3GSGEH.CauseCodeLaunchButton);
        waitForPageLoadingToComplete();
        assertTrue("Can't open SGSN Cause Code Analysis page", selenium.isTextPresent("SGSN-MME Cause Code Analysis"));
        ...
        assertTrue("SGSN Sub Cause Code Analysis page didn't open", selenium
                .isTextPresent("SGSN-MME Sub Cause Code Analysis"));
        // networkTab.checkTableValidity(causeCodeAnalysisWindow, searchValue);
    }
    ...
    public void displayFailureForSelectedBSCAndDrillCauseCodeToSubCauseCodeLevel_4_8_11() throws Exception {
    	openContollerCauseCodeAnalysisWindow();
        ...
        //causeCodeAnalysisWindow.clickCauseCodes("x-grid-group-div");
    	  selenium.click(base2G3GSGEH.CauseCodeLaunchButton);
    	waitForPageLoadingToComplete();
        assertTrue("Can't open Controller Cause Code Analysis page", selenium.isTextPresent("Controller Cause Code Analysis"));
        // networkTab.checkTableValidity(causeCodeAnalysisWindow, searchValue);
    ...
    public void displayFailureForSelectedCellAndDrillCauseCodeToSubCauseCodeLevel_4_8_12() throws Exception {
    	openAccessAreaCauseCodeAnalysisWindow();
        ...
        // Action 3
        //causeCodeAnalysisWindow.clickCauseCodes("x-grid-group-div");
        assertTrue("Can't open Access Area Cause Code Analysis page", selenium.isTextPresent("Access Area Cause Code Analysis"));
        // networkTab.checkTableValidity(causeCodeAnalysisWindow, searchValue);
    ...
    public void displayFailureForSelectedAPNAndDrillCauseCodeToSubCauseCodeLevel_4_8_13() throws Exception {
        ...
        workspaceRC.launchWindow(
    			SeleniumConstants.APN,
    			searchValue,
    			base2G3GSGEH.CorePS,
    			base2G3GSGEH.CauseCodeAnalysis
    			);
        selenium.click(base2G3GSGEH.CauseCodeLaunchButton);
        waitForPageLoadingToComplete();
        ...
        ///causeCodeAnalysisWindow.clickCauseCodes("x-grid-group-div");
        //waitForPageLoadingToComplete();
        assertTrue("Can't open APN Cause Code Analysis page", selenium.isTextPresent("APN Cause Code Analysis"));
        // networkTab.checkTableValidity(causeCodeAnalysisWindow, searchValue);
    ...
    public void displayGraphicalEventSummary_4_8_14() throws Exception {
         ...
         workspaceRC.launchWindow(
     			SeleniumConstants.SGSN_MME,
     			searchValue,
     			base2G3GSGEH.CorePS,
     			base2G3GSGEH.eventVolume
     			);
    ...
    public void displayRoamingAnalysisView_4_8_16() throws Exception {
        ...
        // Action 1
    	 workspaceRC.launchWindow(
      			SeleniumConstants.CORE_NETWORK_PS,
      			base2G3GSGEH.eventVolume,
      			base2G3GSGEH.roamingByOperator
      			);
    ...
    public void openDefaultViewForNodeGroupAPN_4_8_20() throws Exception {
        ...
        workspaceRC.launchWindow(
    			SeleniumConstants.APN_GROUP,
    			searchGroupValue,
    			base2G3GSGEH.CorePS,
    			base2G3GSGEH.networkEventAnalysis
    			);
        //selenium.click(base2G3GSGEH.CauseCodeLaunchButton);
        pause(5000);
  ...
  //      pause(4000);
    //    networkTab.enterSubmit(true);
      //  waitForPageLoadingToComplete();
         ...
         selenium.isTextPresent("APN Group Event Analysis"));
        // assertTrue("Error occured in page loading",
        // selenium.waitForPageLoadingToComplete());
        // pause(4000);
    }
    ...
    public void openDefaultViewForNodeGroupController_4_8_20b() throws Exception {
        ...
        workspaceRC.launchWindow(
    			SeleniumConstants.CONTROLLER_GROUP,
    			searchGroupValue,
    			base2G3GSGEH.CorePS,
    			base2G3GSGEH.networkEventAnalysis
    			);
...
//        assertTrue("Can't open KPI Event Analysis window", selenium.isTextPresent("KPI Event Analysis"));
    ...
    public void viewKPIDrillDownsForAccessArea_4_8_24() throws Exception {
        ...
        final String searchValue = reservedDataHelper.getCommonReservedData(CommonDataType.ACCESS_AREA);
        workspaceRC.launchWindow(
       			SeleniumConstants.ACCESS_AREA,
       			searchValue,
       			base2G3GSGEH.CorePS,
       			base2G3GSGEH.networkEventAnalysis
       			);
        assertTrue("Can't open Access Area Event Analysis window", selenium.isTextPresent("Access Area Event Analysis"));
    ...
    private void openCauseCodeAnalysisWindow() throws PopUpException, InterruptedException {
        //networkTab.openTab();
    ...
    private void openContollerCauseCodeAnalysisWindow() throws PopUpException, InterruptedException {
    	final String searchValue = reservedDataHelper.getCommonReservedData(CommonDataType.CONTROLLER); 
        workspaceRC.launchWindow(
    			SeleniumConstants.CONTROLLER,
    			searchValue,
    ...
    private void openAccessAreaCauseCodeAnalysisWindow() throws PopUpException, InterruptedException {
        final String searchValue = reservedDataHelper.getCommonReservedData(CommonDataType.ACCESS_AREA); 
        workspaceRC.launchWindow(
    			SeleniumConstants.ACCESS_AREA,
    			searchValue,
    ...
    private void drillCauseCodeAnalysisDownToSubCauseCode(final String accessAreaGroup, final NetworkType type,
       ...
       // networkTab.openStartMenu(NetworkTab.StartMenu.CAUSE_CODE_ANALYSIS);
    	workspaceRC.launchWindow(
    			SeleniumConstants.ACCESS_AREA_GROUP,
    			accessAreaGroup,
    			base2G3GSGEH.CorePS,
    			base2G3GSGEH.CauseCodeAnalysis
    			);
