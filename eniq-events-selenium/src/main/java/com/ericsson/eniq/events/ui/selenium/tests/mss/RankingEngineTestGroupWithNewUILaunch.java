...
public class RankingEngineTestGroupWithNewUILaunch extends 
//EniqEventsWebDriverBaseUnitTest {
EniqEventsUIBaseSeleniumTest {
   ...
   /* final List<String> expectedHeadersOnSelectedIMSI = new ArrayList<String>(Arrays.asList(
    ...
    //New values
    final List<String> expectedHeadersOnSelectedIMSI = new ArrayList<String>(Arrays.asList(
            GuiStringConstants.EVENT_TIME,GuiStringConstants.MSC, 
            GuiStringConstants.EXTERNAL_PROTOCOL,
            GuiStringConstants.INCOMING_ROUTE,
            GuiStringConstants.OUTGOING_ROUTE,
            GuiStringConstants.CONTROLLER,
            GuiStringConstants.ACCESS_AREA,
            GuiStringConstants.TAC,GuiStringConstants.IMSI,
             GuiStringConstants.TERMINAL_MAKE,
            GuiStringConstants.TERMINAL_MODEL,  GuiStringConstants.EVENT_RESULT,
            GuiStringConstants.EXTERNAL_CAUSE_VALUE,
    ...
    //updated as per new changes
    final List<String> expectedHeadersOnTerminalRanking = new ArrayList<String>(Arrays.asList(GuiStringConstants.RANK,
            GuiStringConstants.TERMINAL_MAKE, GuiStringConstants.TERMINAL_MODEL, GuiStringConstants.TAC,GuiStringConstants.FAILURES, 
    ...
    public void SubscriberRankingSummarySupportTop50AsDefault_6_1() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_DROPPED_VOICE_CALLS_BY_SUBSCRIBER;
		openRankingWindowForMSS(categoryPanel, windowOption);
...
*/
    ...
    public void CauseCodeRankingSummarySupportTop50AsDefault_6_4() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_CAUSE_CODE_RANKING;
...
*/
	...
	private void closePreviousWindow() {
		//NAR  work around to overcome multiple window problem. close one window
    	selenium.click(closeButtonXPath);
	}
    ...
    /**
     *  Test Case: 4.6.14
     *  Verify Subscriber ranking summary can support to view top 50 subscribers who experienced the most blocked call 
    ...
    public void SubscriberRankingSummarySupportTop50AsDefault_6_14() throws Exception {
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_BLOCKED_VOICE_CALLS_BY_SUBSCRIBER;		
    ...
    public void AccessAreaRankingSummarySupportTop50AsDefaultForBlockedCalls_6_21() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_BLOCKED_VOICE_CALLS_BY_ACCESS_AREA;		
...
*/        
    ...
    public void ShowWorstPerformingAccessAreaByFailures_6_24() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_DROPPED_VOICE_CALLS_BY_ACCESS_AREA;		
...
*/                
    ...
    public void RNCControllerRankingViewBlockedCalls_6_29() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_BLOCKED_VOICE_CALLS_BY_RNC;		
...
*/
        ...
        assertTrue(GuiStringConstants.CONTROLLER + DataIntegrityConstants.RANKING_ANALYSIS_ERROR_MESSAGE,
                RankingAnalysis.rankingAnalysis(completeUITableValues, expectedHeadersOnRNCRanking,
                        GuiStringConstants.CONTROLLER, DataIntegrityConstants.STATUS_BLOCKED, duration));
    ...
    public void RNCControllerRankingViewDroppedCalls_6_30() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_DROPPED_VOICE_CALLS_BY_RNC;		
...
*/
        ...
        assertTrue(GuiStringConstants.CONTROLLER + DataIntegrityConstants.RANKING_ANALYSIS_ERROR_MESSAGE,
                RankingAnalysis.rankingAnalysis(completeUITableValues, expectedHeadersOnRNCRanking,
                        GuiStringConstants.CONTROLLER, DataIntegrityConstants.STATUS_DROPPED, duration));
    ...
    public void BSCControllerRankingViewBlockedCall_6_31() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_BLOCKED_VOICE_CALLS_BY_BSC;		
...
*/        
    ...
    public void BSCControllerRankingViewDroppedCall_6_32() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_DROPPED_VOICE_CALLS_BY_BSC;		
...
*/
    ...
    public void TerminalRankingViewBlockedCalls_6_34() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_BLOCKED_VOICE_CALLS_BY_TERMINAL;		
...
*/        
    ...
    public void TerminalRankingViewDroppedCalls_6_35() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_DROPPED_VOICE_CALLS_BY_TERMINAL;		
...
*/    	
    ...
    public void RankingViewLongDurationCalls_6_36() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_LONG_DURATION_CALLS;		
...
*/        
    ...
    public void RankingViewShortDurationCalls_6_37() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_SHORT_DURATION_CALLS;		
...
*/        
    ...
    public void MsOriginatingUnansweredCallsRanking50AsDefault_6_40() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_MS_ORIGINATING_UNANSWERED_CALLS;		
...
*/        
    ...
    public void MsTerminatingUnansweredCallsRanking50AsDefault_6_44() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_MS_TERMINATING_UNANSWERED_CALLS;		
...
*/                
    ...
    public void VerifyMSCRankingBlockedCallsSummary_6_48() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_BLOCKED_VOICE_CALLS_BY_MSC;		
...
*/
    ...
    public void VerifyMSCRankingDroppedCallsSummary_6_49() throws Exception {
    	...
    	String categoryPanel = MssConstants.CATEGORY_CORE_RANKING;
		String windowOption = MssConstants.WINDOW_OPTION_DROPPED_VOICE_CALLS_BY_MSC;		
...
*/        
        ...
        mscDroppedRankingWindow.setTimeRange(getTimeRangeFromProperties());
        waitForPageLoadingToComplete();
        mscDroppedRankingWindow.sortTable(SortType.ASCENDING, "MSC");
        ...
        assertTrue("Table header is not right after clicking " + GuiStringConstants.MSC, networkEventAnalysis
                .getTableHeaders().containsAll(expectedHeadersOnSelectedMSC));
        //checkWindowUpdatedForTimeRanges(GuiStringConstants.MSC, networkEventAnalysis);
        checkWindowUpdatedForTimeRangesWithDataIntegrity(GuiStringConstants.MSC, networkEventAnalysis,
                expectedHeadersOnMSCRanking, GuiStringConstants.MSC, DataIntegrityConstants.STATUS_DROPPED,
                DataIntegrityConstants.FAILURE_ANALYSIS_ERROR_MESSAGE);
    ...
    private void checkWindowUpdatedForTimeRanges(final String networkType, final CommonWindow commonWindow)
    	...
    	//NAR Temporarily commenting the title checking
    ...
    public void checkWindowUpdatedForTimeRangesWithDataIntegrity(final String networkType,
        ...
        for (final TimeRange time : timeRanges) {
            ...
            if (!timeLabel.equalsIgnoreCase("5 minutes")) {
            	commonWindow.setTimeRange(time);  // added to compute common timerange before custom date and time;
                ...
                if (!ValidationString.equalsIgnoreCase(DataIntegrityConstants.STATUS_NONE)) {
                    ...
                    } else if (ValidationString.equalsIgnoreCase(DataIntegrityConstants.FAILURE_ANALYSIS_ERROR_MESSAGE)) {   // added a new elseif for Dropped callS summary for MSC.
                      //final TimeRange timeRange = getTimeRangeFromProperties();
                    	...
                    	assertTrue(DataIntegrityConstants.FAILURE_ANALYSIS_ERROR_MESSAGE + msc, NetworkAnalysis.eventAnalysis(
                                dataDisplayedOnUI, eventTypes, GuiStringConstants.MSC, msc, "NOT_SPECIFIC",
                                expectedHeadersOnSelectedMSC, time.getMiniutes()));
    ...
    private void delayAndSetTimeRange(final TimeRange timeRange, final CommonWindow window) throws PopUpException {
       ...
       /* if (timeRange == TimeRange.ONE_DAY) {
        ...
        }*/                                   // commented because time range in minutes was substracted twice for one day;
        date.setTimeInMillis(endDateTime);
        ...
        // Concatenate AM/PM, HOUR and MIN to form a member variable of TimeCandidate i.e AM_HOUR_MIN
	...
	private void openRankingWindowForMSS(
